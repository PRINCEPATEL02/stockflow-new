 ...
 * Run this script to create all necessary tables in your PostgreSQL database.
 * 
 * Usage: node config/create-tables.js
 */
...
const createTables = async () => {
  ...
  try {
    ...
    `)
    console.log('✓ Raw materials table created')
    ...
    `)
    console.log('✓ Warranties table created')
